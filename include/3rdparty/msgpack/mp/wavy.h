...
public:
    ...
    shared_ptr<Handler> add_handler(Types... args);

    template <typename F, typename... Types>
    void submit(F f, Types... args);
...
template <typename Handler, typename... Types>
shared_ptr<Handler> loop::add_handler(Types... args)
    { return static_pointer_cast<Handler>(add_handler_impl(
            shared_ptr<Handler>(new Handler(args...))) ); }

template <typename F, typename... Types>
inline void loop::submit(F f, Types... args)
    { submit_impl(bind(f, args...)); }
