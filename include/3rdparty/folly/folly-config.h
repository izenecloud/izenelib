...
/* Define to 1 if you have the `double_conversion_pic' library
   (-ldouble_conversion_pic). */
#ifndef FOLLY_HAVE_LIBDOUBLE_CONVERSION_PIC
#define FOLLY_HAVE_LIBDOUBLE_CONVERSION_PIC 1
#endif
