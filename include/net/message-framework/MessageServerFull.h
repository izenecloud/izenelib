...
protected:
	...
	void sendServiceRegistrationRequest(
			ServiceRegistrationMessage& registMessage);
	 ...
	 */
	void receiveServiceRegistrationReply(const std::string& serviceName,
...
private:
	 ...
	 * differenet minor id
	 */
	std::map<unsigned int, std::vector<boost::shared_ptr<ServiceResult> > >
			resultCacheMap_;
