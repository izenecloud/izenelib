#ifndef SF1COMMON_PROPERTY_VALUE_H
#define SF1COMMON_PROPERTY_VALUE_H
#include "type_defs.h"
...
MAKE_FEBIRD_SERIALIZATION(izenelib::PropertyValue)
...
inline const std::string& propstr_to_str(
    const izenelib::PropertyValue::PropertyValueStrType& propstr,
    izenelib::util::UString::EncodingType encode = izenelib::util::UString::UTF_8)
{
    return propstr;
}
...
inline const izenelib::PropertyValue::PropertyValueStrType& str_to_propstr(const std::string& prop_str,
    izenelib::util::UString::EncodingType encode = izenelib::util::UString::UTF_8)
{
    return prop_str;
}

inline izenelib::PropertyValue::PropertyValueStrType ustr_to_propstr(
    const izenelib::util::UString& prop_ustr,
    izenelib::util::UString::EncodingType encode = izenelib::util::UString::UTF_8)
{
    std::string prop_str;
...
inline izenelib::PropertyValue& operator>>(object o, izenelib::PropertyValue& v)
{
    int type;
    ...
    if (type == 0)
    {
        ...
        else if (s[0] == STR_TYPE_USTRING)
        {
            ...
            v = ustr_to_propstr(ustr);
        }
        else
        {
            std::string str = s.substr(1);
            v = str_to_propstr(str);
        }
    }
    else if(type == 1)
    {
...
inline packer<Stream>& operator<< (packer<Stream>& o, const izenelib::PropertyValue& cv)
{
    izenelib::PropertyValue& v = const_cast<izenelib::PropertyValue&>(cv);
...
inline void operator<< (object& o, izenelib::PropertyValue v)
{
    msgpack::sbuffer sbuf;
    msgpack::packer<msgpack::sbuffer> pk(&sbuf);
    int type = v.which();
...
inline void operator<< (object::with_zone& o, izenelib::PropertyValue v)
{
    msgpack::sbuffer sbuf;
    msgpack::packer<msgpack::sbuffer> pk(&sbuf);
    int type = v.which();
