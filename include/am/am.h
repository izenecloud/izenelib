...
template<typename KeyType, typename ValueType, typename LockType=NullLock,
		typename Alloc=std::allocator<DataType<KeyType,ValueType> > > class AccessMethod {
public:
...
template<typename KeyType, typename LockType, typename Alloc > class AccessMethod<
		KeyType, NullType, LockType, Alloc> {
public:
	typedef KeyType key_type;
