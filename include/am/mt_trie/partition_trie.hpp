...
template <typename NodeIDType,
          typename LockType>
class GeneralTrieDataTable : public CommonDataTable<NodeIDType, NullType, LockType>
{
    typedef CommonDataTable<NodeIDType, NullType, LockType> CommonType;
    typedef GeneralTrieDataTable<NodeIDType, LockType> ThisType;
...
public:
    ...
    GeneralTrieDataTable(const std::string& name)
    : CommonType(name), db_(name) { }

    virtual ~GeneralTrieDataTable() { }
...
class PartitionTrie
    : public CommonTrie<StringType,
                        ...
                        PartitionTrieEdgeTable<typename StringType::value_type,
                                               NodeIDType,
                                               NullLock>,
                        GeneralTrieDataTable  <NodeIDType,
                                               NullLock> >
{
public:
    ...
    typedef GeneralTrieDataTable  <NodeIDType, NullLock>
            DataTableType;
...
public:
    ...
    typedef GeneralTrieDataTable  <NodeIDType, izenelib::util::ReadWriteLock>
            DataTableType;
