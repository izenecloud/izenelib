 ...
 */
static inline uint32_t countOnes(uint32_t x) {
 ...
 */
static inline uint32_t countOnes(uint64_t v) {
    return countOnes(static_cast<uint32_t> (v)) + countOnes(
            static_cast<uint32_t> (v >> 32));
}

static inline uint32_t countOnes(uint16_t v) {
    return countOnes(static_cast<uint32_t>(v));
}


static inline uint32_t numberOfTrailingZeros(uint32_t x) {
    if (x == 0) return 32;
    return ctz32(x);
}


static inline uint32_t numberOfTrailingZeros(uint64_t x) {
...
static inline uint32_t numberOfTrailingZeros(uint16_t x) {
    if (x == 0) return 16;
    return ctz16(x);
}
...
inline std::string toBinaryString(const uword w) {
