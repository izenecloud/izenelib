...
template <
  ...
  uint8_t APPEND_RATE
  >
const size_t vector_string<CHAR_TYPE ,COPY_ON_WRITE, APPEND_RATE>::npos = -1;//!< A static member constant value with the greatest possible value for an element of type size_t.
