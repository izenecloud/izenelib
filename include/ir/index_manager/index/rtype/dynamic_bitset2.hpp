/// @brief Add a get_buffer function than standard boost::dynamic_bitset, used for compress
/// @author Jia Guo

#ifndef BOOST_DYNAMIC_BITSET_DYNAMIC_BITSET2_HPP
#define BOOST_DYNAMIC_BITSET_DYNAMIC_BITSET2_HPP
...
public:
    ...
    class reference
    {
        friend class dynamic_bitset2<Block, Allocator>;
    ...
    // constructors, etc.
    explicit
    dynamic_bitset2(const Allocator& alloc = Allocator());

    explicit
    dynamic_bitset2(size_type num_bits, unsigned long value = 0,
    ...
    dynamic_bitset2(const std::basic_string<CharT, Traits, Alloc>& s,
    ...
    dynamic_bitset2(BlockInputIterator first, BlockInputIterator last,
                   const Allocator& alloc = Allocator())
    ...
    // copy constructor
    dynamic_bitset2(const dynamic_bitset2& b);
    ...
    void swap(dynamic_bitset2& b);
    dynamic_bitset2& operator=(const dynamic_bitset2& b);
    ...
    dynamic_bitset2& operator^=(const dynamic_bitset2& b);
    dynamic_bitset2& operator-=(const dynamic_bitset2& b);
    dynamic_bitset2& operator<<=(size_type n);
    dynamic_bitset2& operator>>=(size_type n);
    dynamic_bitset2 operator<<(size_type n) const;
    dynamic_bitset2 operator>>(size_type n) const;

    // basic bit operations
    dynamic_bitset2& set(size_type n, bool val = true);
    dynamic_bitset2& set();
    dynamic_bitset2& reset(size_type n);
    dynamic_bitset2& reset();
    dynamic_bitset2& flip(size_type n);
    dynamic_bitset2& flip();
    bool test(size_type n) const;
    bool any() const;
    bool none() const;
    dynamic_bitset2 operator~() const;
    ...
    bool is_subset_of(const dynamic_bitset2& a) const;
    bool is_proper_subset_of(const dynamic_bitset2& a) const;
    bool intersects(const dynamic_bitset2 & a) const;
    ...
    friend bool operator==(const dynamic_bitset2<B, A>& a,
                           const dynamic_bitset2<B, A>& b);
    ...
    friend void to_block_range(const dynamic_bitset2<B, A>& b,
                               BlockOutputIterator result);

    template <typename BlockIterator, typename B, typename A>
    friend void from_block_range(BlockIterator first, BlockIterator last,
                                 dynamic_bitset2<B, A>& result);


    template <typename CharT, typename Traits, typename B, typename A>
    friend std::basic_istream<CharT, Traits>& operator>>(std::basic_istream<CharT, Traits>& is,
                                                         dynamic_bitset2<B, A>& b);

    template <typename B, typename A, typename stringT>
    friend void to_string_helper(const dynamic_bitset2<B, A> & b, stringT & s, bool dump_all);
...
BOOST_DYNAMIC_BITSET_PRIVATE:
    ...
    class bit_appender {
      ...
      // client code everything works *as if* dynamic_bitset2<> had
    ...
    public:
        bit_appender(dynamic_bitset2 & r) : bs(r), n(0), mask(0), current(0) {}
        ~bit_appender() {
...
const typename dynamic_bitset2<Block, Allocator>::block_width_type
dynamic_bitset2<Block, Allocator>::bits_per_block;

template <typename Block, typename Allocator>
const typename dynamic_bitset2<Block, Allocator>::size_type
dynamic_bitset2<Block, Allocator>::npos;

template <typename Block, typename Allocator>
const typename dynamic_bitset2<Block, Allocator>::block_width_type
dynamic_bitset2<Block, Allocator>::ulong_width;
...
// comparison
template <typename Block, typename Allocator>
bool operator!=(const dynamic_bitset2<Block, Allocator>& a,
                const dynamic_bitset2<Block, Allocator>& b);
...
template <typename Block, typename Allocator>
std::istream& operator>>(std::istream& is, dynamic_bitset2<Block,Allocator>& b);
#else
...
operator>>(std::basic_istream<CharT, Traits>& is,
           dynamic_bitset2<Block, Allocator>& b);
#endif

// bitset operations
template <typename Block, typename Allocator>
dynamic_bitset2<Block, Allocator>
operator&(const dynamic_bitset2<Block, Allocator>& b1,
          const dynamic_bitset2<Block, Allocator>& b2);
...
template<typename Block, typename Allocator>
void swap(dynamic_bitset2<Block, Allocator>& b1,
          dynamic_bitset2<Block, Allocator>& b2);


template <typename Block, typename Allocator, typename stringT>
void
to_string(const dynamic_bitset2<Block, Allocator>& b, stringT & s);

template <typename Block, typename Allocator, typename BlockOutputIterator>
void
to_block_range(const dynamic_bitset2<Block, Allocator>& b,
               BlockOutputIterator result);
...
//=============================================================================
// dynamic_bitset2 implementation
...
template <typename Block, typename Allocator>
dynamic_bitset2<Block, Allocator>::dynamic_bitset2(const Allocator& alloc)
...
template <typename Block, typename Allocator>
dynamic_bitset2<Block, Allocator>::
dynamic_bitset2(size_type num_bits, unsigned long value, const Allocator& alloc)
    : m_bits(alloc),
      m_num_bits(0)
{
...
// copy constructor
template <typename Block, typename Allocator>
inline dynamic_bitset2<Block, Allocator>::
dynamic_bitset2(const dynamic_bitset2& b)
...
template <typename Block, typename Allocator>
inline void dynamic_bitset2<Block, Allocator>::
swap(dynamic_bitset2<Block, Allocator>& b) // no throw
{
...
template <typename Block, typename Allocator>
dynamic_bitset2<Block, Allocator>& dynamic_bitset2<Block, Allocator>::
operator=(const dynamic_bitset2<Block, Allocator>& b)
{
    m_bits = b.m_bits;
...
template <typename Block, typename Allocator>
inline typename dynamic_bitset2<Block, Allocator>::allocator_type
dynamic_bitset2<Block, Allocator>::get_allocator() const
{
...
template <typename Block, typename Allocator>
void dynamic_bitset2<Block, Allocator>::
...
template <typename Block, typename Allocator>
dynamic_bitset2<Block, Allocator>&
dynamic_bitset2<Block, Allocator>::operator&=(const dynamic_bitset2& rhs)
{
...
template <typename Block, typename Allocator>
dynamic_bitset2<Block, Allocator>&
dynamic_bitset2<Block, Allocator>::operator<<=(size_type n)
{
    if (n >= m_num_bits)
        return reset();
    //else
...
//
template <typename B, typename A>
dynamic_bitset2<B, A> & dynamic_bitset2<B, A>::operator>>=(size_type n) {
    if (n >= m_num_bits) {
        return reset();
    }
    //else
...
template <typename Block, typename Allocator>
dynamic_bitset2<Block, Allocator>
dynamic_bitset2<Block, Allocator>::operator<<(size_type n) const
{
    dynamic_bitset2 r(*this);
    return r <<= n;
}
...
template <typename Block, typename Allocator>
dynamic_bitset2<Block, Allocator>&
dynamic_bitset2<Block, Allocator>::set(size_type pos, bool val)
{
...
template <typename Block, typename Allocator>
dynamic_bitset2<Block, Allocator>&
dynamic_bitset2<Block, Allocator>::set()
{
...
template <typename Block, typename Allocator>
dynamic_bitset2<Block, Allocator>&
dynamic_bitset2<Block, Allocator>::reset(size_type pos)
{
    assert(pos < m_num_bits);
...
template <typename Block, typename Allocator>
dynamic_bitset2<Block, Allocator>&
dynamic_bitset2<Block, Allocator>::reset()
{
  std::fill(m_bits.begin(), m_bits.end(), Block(0));
  return *this;
}
...
template <typename Block, typename Allocator>
dynamic_bitset2<Block, Allocator>&
dynamic_bitset2<Block, Allocator>::flip(size_type pos)
{
    assert(pos < m_num_bits);
    m_bits[block_index(pos)] ^= bit_mask(pos);
    return *this;
...
template <typename Block, typename Allocator>
dynamic_bitset2<Block, Allocator>&
dynamic_bitset2<Block, Allocator>::flip()
{
    for (size_type i = 0; i < num_blocks(); ++i)
        m_bits[i] = ~m_bits[i];
    m_zero_unused_bits();
...
template <typename Block, typename Allocator>
bool dynamic_bitset2<Block, Allocator>::m_unchecked_test(size_type pos) const
{
    return (m_bits[block_index(pos)] & bit_mask(pos)) != 0;
}

template <typename Block, typename Allocator>
bool dynamic_bitset2<Block, Allocator>::test(size_type pos) const
{
    assert(pos < m_num_bits);
...
template <typename Block, typename Allocator>
bool dynamic_bitset2<Block, Allocator>::any() const
{
    for (size_type i = 0; i < num_blocks(); ++i)
        if (m_bits[i])
            return true;
...
template <typename Block, typename Allocator>
inline bool dynamic_bitset2<Block, Allocator>::none() const
{
    return !any();
}
...
template <typename Block, typename Allocator>
dynamic_bitset2<Block, Allocator>
dynamic_bitset2<Block, Allocator>::operator~() const
{
    dynamic_bitset2 b(*this);
    b.flip();
    return b;
}

template <typename Block, typename Allocator>
typename dynamic_bitset2<Block, Allocator>::size_type
dynamic_bitset2<Block, Allocator>::count() const
{
...
template <typename B, typename A, typename stringT>
void to_string_helper(const dynamic_bitset2<B, A> & b, stringT & s,
                      bool dump_all)
{
    ...
    typedef typename dynamic_bitset2<B, A>::size_type size_type;

    const size_type len = dump_all?
         dynamic_bitset2<B, A>::bits_per_block * b.num_blocks():
         b.size();
    s.assign (len, zero);
...
template <typename B, typename A, typename stringT>
inline void
dump_to_string(const dynamic_bitset2<B, A>& b, stringT& s)
{
...
template <typename Block, typename Allocator>
unsigned long dynamic_bitset2<Block, Allocator>::
to_ulong() const
{
  ...
  if (find_next(ulong_width - 1) != npos)
    throw std::overflow_error("boost::dynamic_bitset2::to_ulong overflow");
...
template <typename Block, typename Allocator>
inline typename dynamic_bitset2<Block, Allocator>::size_type
dynamic_bitset2<Block, Allocator>::size() const
{
    return m_num_bits;
}
...
template <typename Block, typename Allocator>
inline typename dynamic_bitset2<Block, Allocator>::size_type
dynamic_bitset2<Block, Allocator>::num_blocks() const
{
    return m_bits.size();
}
...
template <typename Block, typename Allocator>
inline typename dynamic_bitset2<Block, Allocator>::size_type
dynamic_bitset2<Block, Allocator>::max_size() const
{
...
template <typename Block, typename Allocator>
inline bool dynamic_bitset2<Block, Allocator>::empty() const
{
  return size() == 0;
}

template <typename Block, typename Allocator>
bool dynamic_bitset2<Block, Allocator>::
is_subset_of(const dynamic_bitset2<Block, Allocator>& a) const
{
    assert(size() == a.size());
    for (size_type i = 0; i < num_blocks(); ++i)
...
template <typename Block, typename Allocator>
bool dynamic_bitset2<Block, Allocator>::
is_proper_subset_of(const dynamic_bitset2<Block, Allocator>& a) const
{
    assert(size() == a.size());
...
template <typename Block, typename Allocator>
bool dynamic_bitset2<Block, Allocator>::intersects(const dynamic_bitset2 & b) const
{
...
template <typename Block, typename Allocator>
typename dynamic_bitset2<Block, Allocator>::size_type
dynamic_bitset2<Block, Allocator>::m_do_find_from(size_type first_block) const
{
...
template <typename Block, typename Allocator>
typename dynamic_bitset2<Block, Allocator>::size_type
dynamic_bitset2<Block, Allocator>::find_first() const
{
...
template <typename Block, typename Allocator>
typename dynamic_bitset2<Block, Allocator>::size_type
dynamic_bitset2<Block, Allocator>::find_next(size_type pos) const
{
...
template <typename Block, typename Allocator>
inline bool operator!=(const dynamic_bitset2<Block, Allocator>& a,
                       const dynamic_bitset2<Block, Allocator>& b)
{
    return !(a == b);
}
               ...
               const dynamic_bitset2<Block, Allocator>& b)
{
    ...
    typedef typename dynamic_bitset2<Block, Allocator>::size_type size_type;
...
std::ostream&
operator<<(std::ostream& os, const dynamic_bitset2<Block, Alloc>& b)
{
    ...
    if (os.opfx()) {
        ...
        //try
        typedef typename dynamic_bitset2<Block, Alloc>::size_type bitsetsize_type;
...
operator<<(std::basic_ostream<Ch, Tr>& os,
           const dynamic_bitset2<Block, Alloc>& b)
{
...
template <typename Block, typename Alloc>
std::istream&
operator>>(std::istream& is, dynamic_bitset2<Block, Alloc>& b)
{
...
//  the stream's setstate() _cannot_ throw.
    ...
    typedef dynamic_bitset2<Block, Alloc> bitset_type;
...
operator>>(std::basic_istream<Ch, Tr>& is, dynamic_bitset2<Block, Alloc>& b)
{
...
template <typename Block, typename Allocator>
dynamic_bitset2<Block, Allocator>
operator&(const dynamic_bitset2<Block, Allocator>& x,
          const dynamic_bitset2<Block, Allocator>& y)
{
    dynamic_bitset2<Block, Allocator> b(x);
    return b &= y;
}
...
template<typename Block, typename Allocator>
inline void
swap(dynamic_bitset2<Block, Allocator>& left,
     dynamic_bitset2<Block, Allocator>& right) // no throw
{
    left.swap(right);
}
...
template <typename Block, typename Allocator>
inline typename dynamic_bitset2<Block, Allocator>::size_type
dynamic_bitset2<Block, Allocator>::calc_num_blocks(size_type num_bits)
{
...
//
template <typename Block, typename Allocator>
inline Block& dynamic_bitset2<Block, Allocator>::m_highest_block()
{
    return const_cast<Block &>
           (static_cast<const dynamic_bitset2 *>(this)->m_highest_block());
}

// gives a const-reference to the highest block
//
template <typename Block, typename Allocator>
inline const Block& dynamic_bitset2<Block, Allocator>::m_highest_block() const
{
...
//
template <typename Block, typename Allocator>
inline void dynamic_bitset2<Block, Allocator>::m_zero_unused_bits()
{
...
template <typename Block, typename Allocator>
bool dynamic_bitset2<Block, Allocator>::m_check_invariants() const
{
    const block_width_type extra_bits = count_extra_bits();
    if (extra_bits > 0) {
