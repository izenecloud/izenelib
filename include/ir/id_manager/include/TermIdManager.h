...
namespace idmanager 
{
    ...
    class TermIdManager : protected IDFactory<wiselib::UString, unsigned int> 
    {
    ...
    public:
         ...
         */
        TermIdManager(const string& sdbname = "termid_manager", unsigned int initialTermIdValue = 1, unsigned int maxTermIdValue = -2);
    ...
    public:
         ...
         */
        bool getTermIdByTermString(const wiselib::UString& termString, unsigned int& termId);
         ...
         */
        bool getTermStringByTermId(unsigned int termId, wiselib::UString& termString) ;
         ...
         */
        bool getTermIdListByWildcardPattern(const wiselib::UString& wildcardPattern, std::vector<unsigned int>& termIdList);
         ...
         */
        bool getTermIdListByTermStringList(const std::vector<wiselib::UString>& termStringList, std::vector<unsigned int>& termIdList);
         ...
         */
        bool getTermStringListByTermIdList( const std::vector<unsigned int>& termIdList, std::vector<wiselib::UString>& termStringList) ;
    ...
    private:    	
         ...
         */
        LexicalTrie starSearchIndexer_;
