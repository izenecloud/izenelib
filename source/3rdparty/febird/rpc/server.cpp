...
/**
 @brief ���ؽӿڵ�һ�ε���Զ�̶���ķ���ʱ���� rpc server �ϴ���Զ�̶���

  remote_object ����һ�� id��״ֻ̬�� rpc server �ϱ���
 */
...
createNamedGlobaleObject(var_uint32_t* servantID, std::string& className, const std::string& name)
{
	GlobaleScope* x;
	{
		boost::mutex::scoped_lock lock(m_mutex_globaleScopeObjects);
...
rpc_ret_t rpc_server_base::
createGlobaleObject(var_uint32_t* servantID, const std::string& className)
{
	const RoCreator* creator;
	{
		boost::mutex::scoped_lock lock(m_mutex_globaleScopeObjects);
...
rpc_ret_t rpc_server_base::
retrieveGlobaleObject(var_uint32_t* servantID, const std::string& name)
{
	boost::mutex::scoped_lock lock(m_mutex_globaleScopeObjects);
...
createSessionObject(var_uint32_t* servantID, const std::string& className)
{
...
rpc_ret_t session_base::
createNamedSessionObject(var_uint32_t* servantID, std::string& className, const std::string& name)
{
...
rpc_ret_t session_base::
retrieveSessionObject(var_uint32_t* servantID, const std::string& name)
{
...
rpc_ret_t session_base::removeSessionObject(var_uint32_t servantID)
{
