...
int pfordelta_mix_compressor::_compress(uint32_t* const src, char* des, int length)
{
    char* ptr_des = des;
...
int pfordelta_mix_compressor::_decompress(char* const src, uint32_t* des, int length)
{
