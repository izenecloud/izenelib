...
const char* indexFile = "sdb_storage";
...
typedef izenelib::am::DataType<KeyType, string> DataType;
typedef izenelib::am::DataType<KeyType, string> myDataType;
typedef izenelib::am::sdb_storage<KeyType, string> SDB_HASH;
