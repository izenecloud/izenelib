...
const IndexerTestConfig INDEXER_TEST_CONFIGS[] = {
    ...
    {24, 1, 1, "default", true, 8, 3},
    {25, 1, 1, "default", true, 128, 3},
    {26, 1, 1, "realtime", true, 8, 3},
    {27, 1, 1, "realtime", true, 128, 3},
    {28, 1, 1, "default:chunk", true, 128, 3},
    {29, 5, 3, "default", true, 8, 3},
    {30, 5, 3, "default", true, 128, 3},
    {31, 5, 3, "realtime", true, 8, 3},
    {32, 5, 3, "realtime", true, 128, 3},
    {33, 5, 3, "default:chunk", true, 128, 3},
    {34, 10, 6, "default", true, 8, 3},
    {35, 10, 6, "default", true, 128, 3},
    {36, 10, 6, "realtime", true, 8, 3},
    {37, 10, 6, "realtime", true, 128, 3},
    {38, 10, 6, "default:chunk", true, 128, 3},
    {39, 300, 1, "default", true, 8, 3},
    {40, 300, 1, "default", true, 128, 3},
    {41, 300, 1, "realtime", true, 8, 3},
    {42, 300, 1, "realtime", true, 128, 3},
    {43, 300, 1, "default:chunk", true, 128, 3},
    {44, 100, 23, "default", true, 8, 3},
    {45, 100, 23, "default", true, 128, 3},
    {46, 100, 23, "realtime", true, 8, 3},
    {47, 100, 23, "realtime", true, 128, 3},
    {48, 100, 23, "default:chunk", true, 128, 3},
    {49, 1000, 10, "default", true, 8, 3},
    {50, 1000, 10, "default", true, 128, 3},
    {51, 1000, 10, "realtime", true, 8, 3},
    {52, 1000, 10, "realtime", true, 128, 3},
    {53, 1000, 10, "default:chunk", true, 128, 3},
};
